...
public class ComponentIndexerTest {
  ...
  public void index_everything() {
    insert(ComponentTesting.newProjectDto());
  ...
  public void index_unexisting_project_while_database_contains_another() {
    insert(ComponentTesting.newProjectDto("UUID-1"));
  ...
  public void index_one_project() {
    ComponentDto project = ComponentTesting.newProjectDto("UUID-1");
    insert(project);
  ...
  public void index_one_project_containing_a_file() {
    ComponentDto projectComponent = ComponentTesting.newProjectDto("UUID-PROJECT-1");
